...
void setup_scr_screen_detail(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_detail_label_2, "Realtime Param");
    ...
    lv_label_set_text(ui->screen_detail_label_3, "Output Volt");
    ...
    lv_label_set_text(ui->screen_detail_label_4, "Output Curr");
    ...
    lv_label_set_text(ui->screen_detail_label_5, "Output Power");
    ...
    lv_label_set_text(ui->screen_detail_label_6, "Battery Temp");
