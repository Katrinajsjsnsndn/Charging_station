...
void setup_scr_screen_control(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_control_label_1, "Quick Charge");
    ...
    ui->screen_control_list_1_item0 =lv_list_add_text(ui->screen_control_list_1, "Standard Charge");
    ui->screen_control_list_1_item1 =lv_list_add_text(ui->screen_control_list_1, "Quick Charge");
    ui->screen_control_list_1_item2 =lv_list_add_text(ui->screen_control_list_1, "Discharge Test");
    ...
    lv_label_set_text(ui->screen_control_label_2, "Charged");
