...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_2_btn_1_label, "ok");
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 98, 199);
    lv_obj_set_size(ui->screen_2_btn_1, 37, 34);
    ...
    lv_label_set_text(ui->screen_2_btn_2_label, "" LV_SYMBOL_UP " ");
    ...
    lv_obj_set_pos(ui->screen_2_btn_2, 98, 159);
    lv_obj_set_size(ui->screen_2_btn_2, 37, 34);
    ...
    lv_label_set_text(ui->screen_2_btn_3_label, "" LV_SYMBOL_LEFT " ");
    ...
    lv_obj_set_pos(ui->screen_2_btn_3, 50, 199);
    lv_obj_set_size(ui->screen_2_btn_3, 37, 34);
    ...
    lv_label_set_text(ui->screen_2_btn_4_label, "" LV_SYMBOL_RIGHT " ");
    ...
    lv_obj_set_pos(ui->screen_2_btn_4, 152, 199);
    lv_obj_set_size(ui->screen_2_btn_4, 37, 34);
    ...
    lv_label_set_text(ui->screen_2_btn_5_label, "" LV_SYMBOL_DOWN " ");
    ...
    lv_obj_set_pos(ui->screen_2_btn_5, 98, 238);
    lv_obj_set_size(ui->screen_2_btn_5, 37, 34);
    ...
    lv_label_set_text(ui->screen_2_btn_6_label, "back");
    ...
    lv_obj_set_pos(ui->screen_2_btn_6, 139, 272);
    lv_obj_set_size(ui->screen_2_btn_6, 37, 34);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_6, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_btn_7_label, "menu");
    ...
    lv_obj_set_pos(ui->screen_2_btn_7, 57, 272);
    lv_obj_set_size(ui->screen_2_btn_7, 37, 34);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_7, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
