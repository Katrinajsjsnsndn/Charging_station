...
void setup_scr_screen(lv_ui *ui)
{
    ...
    //Write codes screen_Master_screen
    ui->screen_Master_screen = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_Master_screen, -2, -2);
    lv_obj_set_size(ui->screen_Master_screen, 324, 247);
    lv_obj_set_scrollbar_mode(ui->screen_Master_screen, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_Master_screen, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_Master_screen, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_Master_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_Master_screen, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_Master_screen, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_Master_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_Master_screen, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_Master_screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_Master_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_cont_1
    ui->screen_cont_1 = lv_obj_create(ui->screen_Master_screen);
    lv_obj_set_pos(ui->screen_cont_1, 24, 94);
    lv_obj_set_size(ui->screen_cont_1, 117, 55);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x5a9838), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_1, "子站 01");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 23, 7);
    lv_obj_set_size(ui->screen_label_1, 62, 19);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_cont_2 = lv_obj_create(ui->screen_Master_screen);
    lv_obj_set_pos(ui->screen_cont_2, 169, 94);
    lv_obj_set_size(ui->screen_cont_2, 117, 55);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_2, lv_color_hex(0x5a9838), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_2, "子站 01");
    lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_2, 23, 7);
    lv_obj_set_size(ui->screen_label_2, 62, 19);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_cont_3 = lv_obj_create(ui->screen_Master_screen);
    lv_obj_set_pos(ui->screen_cont_3, 24, 164);
    lv_obj_set_size(ui->screen_cont_3, 117, 55);
    ...
    lv_obj_set_style_radius(ui->screen_cont_3, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_3, lv_color_hex(0x5a9838), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_3, "子站 01");
    lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_3, 23, 7);
    lv_obj_set_size(ui->screen_label_3, 62, 19);
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_cont_4 = lv_obj_create(ui->screen_Master_screen);
    lv_obj_set_pos(ui->screen_cont_4, 169, 164);
    lv_obj_set_size(ui->screen_cont_4, 117, 55);
    ...
    lv_obj_set_style_radius(ui->screen_cont_4, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_4, lv_color_hex(0x5a9838), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_4, "子站 01");
    lv_label_set_long_mode(ui->screen_label_4, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_4, 25, 7);
    lv_obj_set_size(ui->screen_label_4, 62, 19);
    ...
    lv_obj_set_style_text_font(ui->screen_label_4, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_5, "主站状态");
    lv_label_set_long_mode(ui->screen_label_5, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_5, 103, 20);
    ...
    lv_obj_set_style_text_color(ui->screen_label_5, lv_color_hex(0xfdf9f9), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_6, "●正常运行");
    lv_label_set_long_mode(ui->screen_label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_6, 103, 48);
    ...
    lv_obj_set_style_text_color(ui->screen_label_6, lv_color_hex(0x1fff95), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_6, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
